export default function Footer() {
  return (
    <footer className="py-12 px-4 bg-espresso border-t border-cream/10">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            <a href="#" className="font-playfair text-2xl font-bold text-gold block mb-2">
              VOLTA COFFEE
            </a>
            <p className="text-cream/80 text-sm">Roasted with purpose since 2019</p>
          </div>
